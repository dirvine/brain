...
// have been around long enough to count them in the fitness evaluation
    ...
    pub fn reproduce_one(generation: u32,
                         ...
                         -> Organism {
        unimplemented!();
        // let mut count=generation; //This will assign genome id's according to the generation
        // let elig_orgs = Vec<Organism>; //This list contains the eligible organisms (KEN)
        //
        // let poolsize;  //The number of Organisms in the old generation
        //
